...
import { 
  Home, LayoutDashboard, Tag, FolderTree, Image, ClipboardList, Users, Percent, Star, Settings, HelpCircle, Mail, Bell, XCircle, ShoppingCart
} from 'lucide-react';
...
const links = [
  ...
  { name: 'Abandoned Carts', view: 'abandoned_carts', icon: <ShoppingCart size={13} /> },
